...
namespace RepositoryLayer
{
            ...
            var items = new List<Item>
    {
        ...
        new Item{ID = 6,SubCategoryID = 3,Name="Heavy Duty Tilt Drum Fan",Description="This Commercial Electric 24 in. heavy-duty tilt drum fan is ideal for spot ventilation in factories, garages, basements, warehouses and anywhere people and machines need to be kept cool. Made with a powerful motor and 2-speed switch, this heavy-duty drum fan lets you optimize air output depending on your needs. Featuring a 180° adjustable tilt, this heavy-duty drum fan can be adjusted to direct airflow exactly where you need it. 2-wheels and sturdy handle allow positioning of the floor fan exactly where you need it or easy transportation from one location to another. Cord wrap for convenient storage.", Price=149, Manufacturer = "Commercial Electric", ProductYear = 2018 , Series = "319343391",Model = "SFDC6-600CT0-4", UseType = "Commercial", Application = "Indoor", MountingLocation="Floor", Accessories = "N/A", Power = 271,Height= 29.92m, Weight = 29.43m, ImageUrl = "~/Content/Images/fan3.jpeg"},
        new Item{ID = 7,SubCategoryID = 3,Name="Heavy Duty Tilt Drum Fan 2",Description="This Commercial Electric 24 in. heavy-duty tilt drum fan is ideal for spot ventilation in factories, garages, basements, warehouses and anywhere people and machines need to be kept cool. Made with a powerful motor and 2-speed switch, this heavy-duty drum fan lets you optimize air output depending on your needs. Featuring a 180° adjustable tilt, this heavy-duty drum fan can be adjusted to direct airflow exactly where you need it. 2-wheels and sturdy handle allow positioning of the floor fan exactly where you need it or easy transportation from one location to another. Cord wrap for convenient storage.", Price=149, Manufacturer = "Commercial Electric", ProductYear = 2018 , Series = "319343391",Model = "SFDC6-600CT0-4", UseType = "Commercial", Application = "Indoor", MountingLocation="Floor", Accessories = "N/A", Power = 271,Height= 29.92m, Weight = 29.43m, ImageUrl = "~/Content/Images/fan3.jpeg"}
    };
